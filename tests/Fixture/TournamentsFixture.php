...
class TournamentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'school_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'fk_Tournaments_Cities' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
            'fk_Tournaments_Schools' => ['type' => 'foreign', 'columns' => ['school_id'], 'references' => ['schools', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
