...
class PlayerTournamentParticipationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'player_tournament_participations_ibfk_1' => ['type' => 'foreign', 'columns' => ['player_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'player_tournament_participations_ibfk_2' => ['type' => 'foreign', 'columns' => ['tournament_id'], 'references' => ['tournaments', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
